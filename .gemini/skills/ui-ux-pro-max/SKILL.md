---
name: UI/UX Pro Max
description: AI-powered design intelligence toolkit with searchable databases of UI styles, color palettes, font pairings, chart types, and UX guidelines. Use for any UI/UX design, build, or review task.
---
